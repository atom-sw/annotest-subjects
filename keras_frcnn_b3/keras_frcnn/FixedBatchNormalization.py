...
class FixedBatchNormalization(Layer):
    ...
    def __init__(self, epsilon=1e-3, axis=-1,
        ...
        # self.beta_init = initializations.get(beta_init)  # repo_change
        self.beta_init = initializers.get(beta_init)  # repo_change
        self.gamma_init = initializations.get(gamma_init)  # repo_bug
