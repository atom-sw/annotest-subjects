...
import os
Path_to_file = (os.path.expanduser('~') + "/annotest_subjects_data/tf_ThinPlateSpline_b15/original.png")
...
def ThinPlateSpline2(U, source, target, out_size):
  ...
  def _meshgrid(height, width, source):
    ...
    x_t_flat_g = tf.tile(x_t_flat, tf.pack([num_batch, 1, 1])) # [bn, 1, h*w]  # repo_bug
