...
bug_id_data_directory_path = (os.path.expanduser('~') +  # repo_change
                              "/annotest_subjects_data/cnn_text_classification_tf_b2/")  # repo_change
    ...
    with sess.as_default():
        ...
        for g, v in grads_and_vars:
            if g is not None:
                ...
                sparsity_summary = tf.scalar_summary("{}/grad/sparsity".format(v.name), tf.nn.zero_fraction(g))  # repo_bug
